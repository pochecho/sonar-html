...
public class HtmlLanguage extends AbstractLanguage {
    public static final String KEY = "web";
    public static final String NAME = "HTML";

    private final Configuration configuration;

    public HtmlLanguage(Configuration settings) {
        super(KEY, NAME);
    ...
    public String[] getFileSuffixes() {
        return configuration.getStringArray(DSSettings.FILE_SUFFIXES_KEY);
    }
